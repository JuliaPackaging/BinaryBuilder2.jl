        ...
        JLLBuildInfo(;
            ...
            products = [
                JLLLibraryProduct(
                    ...
                    "lib/libcurl.4.dylib",
                    [
                        JLLLibraryDep(:nghttp2_jll, :libnghttp2),
                        JLLLibraryDep(:LibSSH2_jll, :libssh2),
                        JLLLibraryDep(:Zlib_jll, :libz),
                    ],
                    ["System", "framework:CoreFoundation", "framework:Security", "framework:SystemConfiguration"],
        ...
        JLLBuildInfo(;
            ...
            products = [
                JLLLibraryProduct(
                    ...
                    ["advapi32", "bcrypt", "crypt32", "gcc_s", "kernel32", "msvcrt", "winpthread", "ws2_32"],
        ...
        JLLBuildInfo(;
            ...
            products = [
                JLLLibraryProduct(
                    ...
                    ["advapi32", "bcrypt", "crypt32", "kernel32", "msvcrt", "winpthread", "ws2_32"],
                    soname = "libcurl-4.dll",
                    flags = [:RTLD_LAZY, :RTLD_DEEPBIND],
                    on_load_callback = :libcurl_on_load_callback_def,
                ),
