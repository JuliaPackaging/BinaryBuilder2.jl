        ...
        JLLBuildInfo(;
            ...
            products = [
                JLLLibraryProduct(
                    ...
                    dlid = Base.UUID("6f70f1a7-e2d5-53ff-bc33-5d3858c96401"),
                ),
                JLLLibraryProduct(
                    :libgcc_s,
                    ...
                    [],
                    flags = [:RTLD_LAZY, :RTLD_DEEPBIND],
                    dlid = Base.UUID("1cd7433b-ee8f-572a-8a86-1137cb3f5ada"),
                ),
                JLLLibraryProduct(
                    :libgfortran,
                    ...
                    flags = [:RTLD_LAZY, :RTLD_DEEPBIND],
                    dlid = Base.UUID("77be8d79-76da-57e6-8c3e-8eb4c9c4a43c"),
                ),
                JLLLibraryProduct(
                    :libgomp,
                    "lib/libgomp.1.dylib",
                    [],
                    flags = [:RTLD_LAZY, :RTLD_DEEPBIND],
                    dlid = Base.UUID("d86a9a2a-2317-558f-a0a8-6a2b7a7addd4"),
                ),
                JLLLibraryProduct(
                    :libssp,
                    "lib/libssp.0.dylib",
                    [],
                    flags = [:RTLD_LAZY, :RTLD_DEEPBIND],
                    dlid = Base.UUID("558536fb-6a72-5deb-a2f9-856b91bb76ef"),
                ),
                JLLLibraryProduct(
                    :libstdcxx,
                    "lib/libstdc++.6.dylib",
                    ...
                    flags = [:RTLD_LAZY, :RTLD_DEEPBIND],
                    dlid = Base.UUID("2afcce28-1804-53d7-8eaf-15b85720ac97"),
                ),
                JLLLibraryProduct(
                    :libquadmath,
                    ...
                    [],
                    flags = [:RTLD_LAZY, :RTLD_DEEPBIND],
                    dlid = Base.UUID("4869bb1d-141f-5a01-b337-3d1435fc1f98"),
                ),
            ],
