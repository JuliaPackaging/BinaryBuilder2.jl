# With a few small exceptions, this is a direct clone of the
# BinaryBuilder 1 build recipe, from https://github.com/JuliaPackaging/Yggdrasil/blob/d46ed4f10a4aafad962f89fb1baa98f50b3348e6/S/SSW/build_tarballs.jl
# It is doubly useful as it has a dependency on Zlib
using BinaryBuilder2, BinaryBuilder2.Compat, Pkg
...
platforms = [Platform(arch(HostPlatform()), "linux"; cxxstring_abi=:cxx11)]
...
dependencies = [
    Dependency(
        # We need to use our BB2-build Zlib here, until BB2 rebuilds Zlib publicly.
        PackageSpec(;
            name = "Zlib_jll",
