...
@testset "build_tarballs()" begin
    ...
    @testset "BinaryBuilder2.Compat" begin
        ...
        @test any(isa.(target_toolchains, CToolchain))
        @test any(isa.(target_toolchains, CMakeToolchain))
        @test any(isa.(host_toolchains, CToolchain))
        @test any(isa.(host_toolchains, HostToolsToolchain))
